...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/canfenerci/Dropbox/IMMEM/Summer_2020/Fluency_Task_PAVLOVIA/Fluency_Task.py',
...
for thisTrial in trials:
    ...
    for index, this_word in enumerate(all_words):
